...
Add more names and species as you like, as long as you follow the array conventions + each species being paired with its own habitat in order
You do not need to change any of the variables otherwise!
AND ALSO ADD AN APPROPRIATE IMAGE SET TO THE IMAGES FOLDER THANKS. Whatever the animal is (keep it lowercase) put that name plus the emotion as a .png
